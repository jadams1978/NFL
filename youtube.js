...
function showResults(data) {
    if (!data.items[0]) {
        ...
        $('.video').html('<iframe width="400" height="200" src="https://www.youtube.com/embed/' + data.items[0].id.videoId + '"frameborder="0" allowfullscreen></iframe><p>' + data.items[0].snippet.title + '</p>');
    }
    console.log(data);
